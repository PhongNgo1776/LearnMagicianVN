    ...
    data: [
            {
                id: 1,
                name: 'CHÂU TINH TRÌ',
                image: require('../../assets/images/chau_tinh_tri.jpg'),
                filmList:
                [
...

                    {
                        ...
                        videoKey: 'qyXOclMafbQ'
                    },

                    {
                        title: 'Trường Học Uy Long 1',
                        content: `Trường học Uy Long I là bộ phim hài Hồng Kông của đạo diễn Gordon Chan và Châu Tinh Trì được sản xuất vào năm 1991. Tiếp sau sự thành công của bộ phim này đã tạo tiền đề cho sự thành công của phần các phần tiếp theo là Trường học Uy Long II và Trường học Uy Long III. Trong bộ phim này Châu Tinh Trì vào vai cảnh sát chìm Chow Sing-Sing, thâm nhập vào một trường trung học với mục tiêu là tìm cho ra cây súng của sếp mình bị đánh cắp. Cùng với sự trợ giúp của các đồng nghiệp cảnh sát cũng giả dạng thành học sinh, công cuộc tìm kiếm của Chow cũng vẫn gặp đầy khó khăn bởi sự lì lợm của những đứa học trò, sự khó chịu của các thầy cô giáo, và hơn nữa là Chow lại đụng độ với tên đầu gấu của trường. Nhưng đối với Chow, để bù lại những khó khăn thử thách đó thì chỉ cần được gặp mặt cô giáo mới chuyển công tác đến trường là đủ.`,
                        videoKey: '9XNuHUNWe8'
                    },

                    {
                        title: 'Trường Học Uy Long 2',
                        content: `Đào Học Uy Long 2 (Fight Back To School 2): Với nội dung phim đặc sắc và kịch tính đạo diễn Gordon Chan và dưới sự diễn xuất tài tình của Châu Tinh Trì đã đem lại thành công rực rỡ cho tác phẩm Trường Học Uy long 1 để lại dấu ấn sâu sắc Năm 1992 tác phẩm Trường Học Uy Long 2 được ra dưới sự đón chờ của nhiều khán giả. Châu Tinh Trì trở lại trong vai cảnh sát chìm Chow Sing-Sing, vừa bị giáng chức xuống làm cảnh sát giao thông vì đã trêu chọc cấp trên của mình. Mặc dù không được chỉ định làm nhiệm vụ nào nhưng anh quyết định xâm nhập vào một trường trung học để điều tra và ngăn chặn một vụ khủng bố đang chuẩn bị tiến hành. Nhưng vấn đề lớn nhất là Bộ Cảnh Sát không muốn anh tham gia vào vụ việc này, sự việc ngày càng trở nên phức tạp cùng những tình tiết hài chết cười và như pha hành động kịch tính. Chúng ta hãy cùng xem anh chàng cảnh sát vui tính Châu Tinh Trì sẽ nhập vai như thế nào nhé`,
                        videoKey: '3joXpIWHqVA'
                    },
    
                    {
                        title: 'Trường Học Uy Long 3',
                        content: `Tiếp nối sự thành công của Trường học Uy Long phần 1 và phần 2 bộ phim hài Hồng Kong của đạo diễn Gordon Chan và Châu Tinh Trì. Năm 1993 tác phẩm Trường Học Uy Long 3 đã đc ra mắt dưới sự mong đợi của nhiều khán giả. Trong Fight Back To School 3 (Trường Học Uy Long 3), Stephen Chow trở về là một nhân viên cảnh sát Chow Sing Sinh, một người làm tay trong đặc biệt. Lần này, anh được điều đi điều tra vụ ám sát của nhà tỷ phú Million Wong, người mà Chow có một sự giống nhau đến kỳ lạ, bằng cách làm ra vẻ bản thân mình là Wong. Cảnh sát liên hệt với bà Wong để nói cho bà biết rằng họ đã xác định được bà ta còn sống nhưng bị mắc chứng quên chồng mình là ai. Qua buổi họp mặt những người bạn lạ lùng và gia đình của Wong, và qua bao nhiêu sự hiểu lầm và sai lầm, Chow nghĩ rằng anh đã có câu trả lời--chỉ phát hiện ra đuợc rằng bạn gái anh, Min, có hẹn với người bị nghi ngờ là thủ phạm. Ai sẽ là thủ phạm?`,
                        videoKey: 'CHcIJ6YG3ZY'
                    },
...

            {
                id: 2,
                name: 'LÍ LIÊN KIỆT',
                image: require('../../assets/images/li_lien_kiet.jpg'),
                filmList:
                [
            ...
            },
            {
                id: 3,
                name: 'THÀNH LONG',
                image: require('../../assets/images/thanh_long.jpg'),
                filmList:
                [

                    {
                        title: '12 Con Giáp',
                        content: ``,
                        videoKey: 'ObBlwVRCJZ8'
                    },

                    {
                        title: '80 Ngày Vòng Quanh Thế Giới',
                        content: ``,
                        videoKey: 'VgnEgL2q7Ls'
                    },

                    {
                        title: 'Câu Chuyện Cảnh Sát 2',
                        content: ``,
                        videoKey: 'Hmc34maHtQk'
                    },
                    ...
                    {
                        title: 'Truyền Thuyết Thiếu Lâm Tự',
                        content: ``,
                        videoKey: 'RVlM_DHCfxg'
                    },
            ...
            },
            {
                id: 4,
                name: 'CHUNG TỬ ĐƠN',
                image: require('../../assets/images/chung_tu_don.jpg'),
                filmList:
                [
                    ...
                    {
                        title: 'SÁT PHÁ LANG 2018',
                        content: ``,
                        videoKey: 'uPNuCw3yI7w'
                    },

                    {
                        title: 'CẨM Y VỆ',
                        content: `MINH TRIỀU CẨM Y VỆ | PHIM HÀNH ĐỘNG VÕ THUẬT HAY FULL HD`,
                        videoKey: '6R3G1wubpwU'
                    },
            ...
            },
            {
                id: 5,
                name: 'NGÔ KINH',
                image: require('../../assets/images/ngo_kinh.jpg'),
                filmList:
                [
...

                    {
                        ...
                        content: `Phim Võ Thuật Ngô Kinh, Cổ Thiên Lạc`,
                        videoKey: '1PJRoVYT5II'
                    },
            ...
            },
            {
                ...
                image: require('../../assets/images/lam_chanh_anh.jpg'),
                filmList:
                [
            ...
            },
            {
                ...
                [
                    ...
                    {
                        title: 'Địch Nhân Kiệt Thông Thiên Đế Quốc',
                        content: `Địch Nhân Kiệt Thông Thiên Đế Quốc`,
                    ...
                    {
                        title: 'Thần kiếm',
                        content: `Thần kiếm sơn trang- Tam thiếu Gia quyết chiến Yến thập Tam`,
                        videoKey: 'XNLfz4FJcUg'
                    },
